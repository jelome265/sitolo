...
| **8** | docs/phase8_product_catalogue_implementation.md | domain_model.md; api_contract.md; database_design.md; Phase 5/6/9/10 contracts; commercial sources | Phase 8 contract + domain/security/data authority | **Partial** | **Partially routed — missing from engineering phase-context router** | **Target-only**; current status treats Phase 8 as later target, not active | Contract exists; no evidence that full catalogue runtime exists | Contract is lightweight; ICM routing omits Phase 8 | Deepen contract to standard phase depth and add explicit router entry |
...
| **11** | **Missing** | payment_integration_spec.md; domain_model.md; api_contract.md; database_design.md; security_implementation_spec.md; implementation_plan.md | Implementation plan + provider/security/domain authority | **Missing** | **Not routed** | Future target; not active | Supporting specifications exist; no dedicated phase evidence package | No unified payment/reconciliation phase contract or exit gate | Create canonical Phase 11 contract; route it; define provider intent/attempt/observation/reconciliation, unknown outcomes, refunds and executable evidence |
| **12** | **Missing** | sync_protocol.md; domain_model.md; database_design.md; api_contract.md; security/testing/deployment contracts | Implementation plan + sync/security/data authority | **Missing** | **Not routed** | Future target; not active | Sync specification exists; no dedicated phase evidence package | No unified client journal, ingestion, checkpoint, replay, conflict and revocation phase contract | Create canonical Phase 12 contract; route it; define client continuity, replay/idempotency, conflict classes, revocation and migration compatibility |
| **13** | **Missing** | domain_model.md; api_contract.md; database_design.md; agent.md; commercial supplier context | Implementation plan + domain/data/security authority | **Missing** | **Not routed** | Future target; not active | Supporting domain/schema evidence only | Procurement rules are distributed | Create canonical Phase 13 contract covering supplier, PO, approval, receipt, discrepancy, inventory posting and operational evidence |
| **14** | **Missing** | domain_model.md; api_contract.md; database_design.md; phase10_pos_sales_implementation.md; agent.md | Implementation plan + domain/financial/security authority | **Missing** | **Not routed** | Future target; not active | Partial supporting evidence only | Void/reversal/return/refund/cash controls are not reconciled as one phase package | Create canonical Phase 14 contract with correction entitlements, register/cash state, idempotency, interactions, audit and recovery gates |
| **15** | **Missing** | mra_eis_integration_spec.md; domain_model.md; api_contract.md; deployment_spec.md; security_implementation_spec.md | Applicable MRA authority + current provider contract + Sitolo security/integration hierarchy | **Missing** | **Not routed** | Future target; not active | Provider integration specification exists; certification evidence absent | No phase-level implementation/certification contract | Create canonical Phase 15 contract; require current MRA primary-source verification before compliance claims |
| **16** | **Missing** | api_contract.md; database_design.md; observability_spec.md; security_implementation_spec.md; implementation_plan.md | Implementation plan + data/security/observability authority | **Missing** | **Not routed** | Future target; not active | Supporting reporting/export requirements exist | No phase-level read-model/export workload and data-exfiltration gate | Create canonical Phase 16 contract with scoping, field allowlists, quotas, async exports, audit and performance evidence |
| **17** | **Missing** | docs/commercial/06_payments_finance/payment_collections_and_subscription_billing.md; domain_model.md; api_contract.md; database_design.md; security contracts | Approved commercial decisions + implementation/security hierarchy | **Missing** | **Not routed** | Future target; not active | Commercial billing source material exists; engineering evidence absent | No engineering phase contract reconciling billing and entitlement authority | Create canonical Phase 17 contract for plans, subscriptions, invoices, payment, reconciliation, entitlements and outage behavior |
| **18** | **Missing** | security_control_register.md; security_incident_response.md; security_exception_register.md; agent.md; implementation_plan.md | Security governance + implementation plan + support governance | **Missing** | **Not routed** | Future target; not active | Support/break-glass requirements exist as distributed controls | No phase-level admin/support implementation gate | Create canonical Phase 18 contract covering JIT, break-glass, queue/admin, incident controls, audit and approval |
| **19** | **Missing** | deployment_spec.md; observability_spec.md; database_design.md; testing_strategy.md; implementation_plan.md | Implementation plan + deployment/reliability/security authority | **Missing** | **Not routed** | Future target; not active | Target requirements are detailed; no phase-specific hardening evidence package | Performance, load, chaos, restore, RPO/RTO and rollback are distributed | Create canonical Phase 19 contract with measurable hardening and DR evidence gates |
| **20** | **Missing** | implementation_plan.md; ci_enforcement.md; deployment_spec.md; security_architecture_design.md; security_control_register.md; release-governance-evidence.md; external_standards_verification_register.md | All applicable higher-authority sources; production governance | **Missing** | **Not routed** | Future certification target | No canonical Phase 20 certification package | Certification criteria are scattered across plan/release/security sources | Create canonical Phase 20 contract defining evidence package, blocking findings, approval authority, artifact identity and final release gate |
